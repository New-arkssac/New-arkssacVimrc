...
local _, icon, color = pcall(require("nvim-web-devicons").get_icon_color, vim.fn.expand("%:e"))
...
G.info = {
    linux = {
        ["kali"] = { icon = " ", cmd = {
            ...
            dapargs = { "--", G.home .. '/.local/share/nvim/mason/bin/dlv', "debug", "--listen=127.0.0.1:38697",
                "--headless",
        ...
        ["arch"] = { icon = " ", cmd = {
            terminal = "alacritty",
            dapargs = { "--class", "float", "-e", G.home .. '/.local/share/nvim/mason/bin/dlv', "debug",
                "--listen=127.0.0.1:38697", "--headless",
                "--log", "--api-version=2", "--accept-multiclient" },
        },
        },
        ["color"] = "#f3b416"
