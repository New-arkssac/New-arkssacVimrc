...
-- autocmd Filetype vimwiki inoremap <buffer> ,b  * <++>* <CR>:nohlsearch<CR>"_c4l
vim.cmd [[
autocmd Filetype markdown TableModeToggle
autocmd Filetype markdown inoremap <buffer> ,f <Esc>/<++><CR>:nohlsearch<CR>"_c4l
autocmd Filetype markdown inoremap <buffer> ,d <Esc>/<++><CR>:nohlsearch<CR>"_c4l
...
autocmd Filetype markdown inoremap <buffer> ,h - [ ] 
